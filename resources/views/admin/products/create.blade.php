            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="productName" value="{{ old('productName') }}" class="form-control">
                        <label id="name-error" class="error" for="name" style="display: none;color:red">Vui lòng nhập
                            tên sản phẩm</label>
                    </div>
                    <div class="form-group">
                        <label>Hình Ảnh:</label>
                        <input type="text" id="image" name="image" class="form-control" value="{{ old('image') }}" multiple>
